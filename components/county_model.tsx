                    ...
                    <>
                      ...
                      <ModalBody>
                        ...
                        <p className="text-sm">
                          ...
                          environmental conditions are averages for the county
                          you chose from the clickable map. If desired, you may
                          adjust some or all of the default settings to more
                          accurately represent the cropping system and area you
                          are interested in.
                        </p>
                        ...
                        <p className="text-sm">
                          ...
                          total greenhouse gas cost for the scenario. If the new
                          scenario has a lower &quot;Total&quot; it means that
                          the new cropping scenario is better for the
